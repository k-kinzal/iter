...
impl ProcessStatus {
    ...
    #[must_use]
    pub(crate) fn as_serde_str(self) -> &'static str {
        match self {
...
pub(crate) struct UnknownStatusToken(pub String);
...
pub(crate) struct StatusTransition {
    ...
    pub(crate) from: ProcessStatus,
    /// Status committed to disk.
    pub(crate) to: ProcessStatus,
}
...
#[must_use]
pub(crate) fn is_allowed(from: ProcessStatus, to: ProcessStatus) -> bool {
...
#[derive(Debug)]
pub(crate) struct CorruptStatusError {
    /// What was wrong with the contents.
    pub(crate) kind: CorruptStatusKind,
...
pub(crate) enum CorruptStatusKind {
