...
use iter_core::log::{LogEntry, LogStream, NdjsonWriter, OutputSink, WriterMsg, writer_dead_error};

use super::sender::LogSender;

/// Default in-flight capacity for the mpsc channel.
pub(crate) const DEFAULT_LOG_BUFFER: usize = 1024;
...
pub(crate) struct ProcessLogSink {
    writer: NdjsonWriter,
...
impl ProcessLogSink {
    ...
    pub(crate) async fn open_in(log_dir: &Path) -> io::Result<Self> {
